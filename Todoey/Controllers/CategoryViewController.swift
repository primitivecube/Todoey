...
//        if let cellBGColour = categories?[indexPath.row].cellColour {
//            cell.backgroundColor = UIColor(hexString: cellBGColour)
//        }
        
        cell.backgroundColor = UIColor(hexString: categories?[indexPath.row].cellColour ?? "1D9BF6")
